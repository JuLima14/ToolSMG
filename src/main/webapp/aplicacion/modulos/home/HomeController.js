...
.config(function($mdThemingProvider) {
  ...
  function HomeController($scope, $timeout, $mdSidenav, $log,$filter, $templateRequest, $sce, $compile,$http){
    ...
    //$scope.vistas.push(new Pantalla(0,"ABM Incidentes","aplicacion/modules/abm-incidentes/views/viewABMIncidentes.html"));
    $scope.vistas.push(new Pantalla(0,"ABM Casos","aplicacion/modulos/abm-casos/views/viewAbmCasos.html"));
    $scope.vistas.push(new Pantalla(1,"ABM Pantallas","aplicacion/modulos/abm-pantallas/views/viewABMPantallas.html"));
